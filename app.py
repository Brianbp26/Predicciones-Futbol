...
def mostrar_partidos(partidos, liga):
    ...
    for numero_jornada, partidos_jornada in jornadas:
        ...
        for partido in partidos_jornada:
            ...
            # Generar el HTML
            st.markdown(f"""
<div class="match-container" style="display: flex; align-items: center; justify-content: space-between; padding: 1rem; background-color: ##030001; margin-bottom: 0.5rem; border-radius: 8px;">
